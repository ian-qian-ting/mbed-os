...
################
Usage() {
    echo "Usage: $0 [Image Name] [Start Symbol Name] [Symbols List File] [Tools Directory]"
}
...
#    MakeFixedWidthHeaderString $RSVD        16  HEADER_FINAL
    MakeFixedWidthHeaderString $IMG2SIGN        16  HEADER_FINAL
fi
